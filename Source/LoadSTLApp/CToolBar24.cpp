...
*  @Return        :: None
**************************************************************************/
void CToolBar24::UpdateColorImage(UINT Icon_ID, UINT Disabled_ID, UINT Hot_ID,int idx)
{
	HICON hicon1 = NULL, hicon2 = NULL, hicon3 = NULL;
	hicon1 = AfxGetApp()->LoadIconW(Icon_ID);
...
void CToolBar24::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos)
{
	...
	//((CMainFrame *)AfxGetApp()->m_pMainWnd)->GetActiveView()->SendMessage(WM_PAINT, 0, 0);
}
